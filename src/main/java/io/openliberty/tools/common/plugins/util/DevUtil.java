...
public abstract class DevUtil {
    ...
    private static final String DEVMODE_PROJECT_ROOT = "io.openliberty.projectRoot";
    private static final String GENERATED_HEADER_REGEX = "# Generated by liberty-.*-plugin";
    private static final String DEFAULT_DOCKER_IMAGE = "openliberty/open-liberty:latest";
    ...
    private boolean defaultDockerfileExists() {
        File defaultDockerfile = new File (projectDirectory.getAbsolutePath() + "/Dockerfile");
