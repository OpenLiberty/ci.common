...
public abstract class DevUtil {
    ...
    /**
     * Determines if the corresponding target file was originally generated by a Liberty plugin
     * 
     ...
     */
    protected boolean isGeneratedTargetFile(File fileChanged, File srcDir, File targetDir) throws IOException {
