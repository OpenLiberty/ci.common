...
public abstract class DevUtil {
    ...
    private static final String PROJECT_ROOT_NAME = "io.openliberty.tools.projectRoot";
    ...
    private String getContainerCommand() {
        ...
        command.append(" -v " + serverDirectory.getAbsolutePath() + "/" + DEVMODE_CONFIG_XML + ":/config/" + DEVMODE_CONFIG_XML);
    ...
    public void generateDevModeConfig(String projectRoot, String header) throws IOException, TransformerException, ParserConfigurationException {
        ...
        configDocument.createVariableWithValue(PROJECT_ROOT_NAME, projectRoot, false);

        // write XML document to file
        File devModeConfig = new File(serverDirectory, DEVMODE_CONFIG_XML);
        makeParentDirectory(devModeConfig);
